...
namespace 测试项目
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Shape_图形接口 shape1 = shapeFactory.GetShape("Factory_工厂模式.Examples_ShapeFactory_图形工厂模式_实例1.Circle_圆形", true);

            // 工厂方法模式
            Factory_工厂方法模式.Examples_ShapeFactory_图形工厂模式_实例1.FactoryPatternDemo.test();
